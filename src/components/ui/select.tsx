...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        // Match Input: gray field, gray border, white + primary on focus
        "flex w-full items-center justify-between gap-2 rounded-md border border-gray-200 bg-gray-100 px-3 py-2 text-sm sm:text-base whitespace-nowrap text-foreground shadow-none",
        ...
        "h-11 sm:h-12 data-[size=sm]:h-8 data-[size=sm]:text-sm",
        "dark:border-input dark:bg-input/30 dark:focus-visible:border-primary dark:focus-visible:bg-background dark:hover:bg-input/50",
