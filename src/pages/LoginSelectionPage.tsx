      ...
      <div className="flex-1 flex items-center justify-center px-4 sm:px-6 py-12 sm:py-16">
        <div className="w-full max-w-5xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
            ...
            return (<motion.div key={userType.id} initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 + index * 0.1, duration: 0.6 }}>
                  <Card className="p-6 sm:p-8 rounded-lg shadow-sm border border-gray-200/50 hover:shadow-xl hover:-translate-y-2 transition-all duration-500 cursor-pointer group h-full" onClick={() => navigate(userType.path)}>
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.5, duration: 0.6 }} className="text-center mt-8 sm:mt-12 space-y-2 sm:space-y-3">
