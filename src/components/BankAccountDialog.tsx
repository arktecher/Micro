      ...
      <DialogContent className="sm:max-w-[500px]">
        ...
        <div className="space-y-4 py-4">
          ...
          <div className="space-y-2">
            ...
            <Input id="bankName" value={bankName} onChange={(e) => setBankName(e.target.value)} placeholder="みずほ銀行"/>
          </div>

          
          <div className="space-y-2">
            <Label htmlFor="branchName">支店名</Label>
            <Input id="branchName" value={branchName} onChange={(e) => setBranchName(e.target.value)} placeholder="渋谷支店"/>
          </div>
          ...
          <div className="space-y-2">
            ...
            <Input id="accountNumber" value={accountNumber} onChange={(e) => setAccountNumber(e.target.value)} placeholder="1234567" maxLength={7}/>
          </div>

          
          <div className="space-y-2">
            <Label htmlFor="accountHolder">口座名義（カタカナ）</Label>
            <Input id="accountHolder" value={accountHolder} onChange={(e) => setAccountHolder(e.target.value)} placeholder="カブシキガイシャ サンプル"/>
          </div>
        ...
        <div className="space-y-2">
          ...
          <Button variant="outline" className="w-full text-red-600 hover:bg-red-50 hover:text-red-700 border-red-200" onClick={() => setShowDeleteConfirm(true)}>
