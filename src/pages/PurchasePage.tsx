    ...
    return (<div className="min-h-screen bg-gradient-to-b from-[#FAFAFA] to-white">
      <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-md border-b border-gray-200/50">
        <div className="container mx-auto px-4 sm:px-6 py-3 sm:py-4 flex items-center justify-between">
          ...
          {currentStep < 4 && (<Button variant="ghost" size="icon" onClick={handleClose} className="rounded-full hover:bg-gray-100">
      ...
      <div className="pt-16 sm:pt-20 pb-8 sm:pb-12">
        <AnimatePresence mode="wait">
          {currentStep === 1 && (<motion.div key="step1" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} transition={{ duration: 0.5 }} className="container mx-auto px-4 sm:px-6 max-w-5xl">
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-12">
                <div className="lg:col-span-2 space-y-6 sm:space-y-8">
                  ...
                  <form onSubmit={onSubmitStep1} className="space-y-6 sm:space-y-8">
                    <div className="space-y-3 sm:space-y-4">
                      <label className={`flex items-start gap-3 sm:gap-4 p-4 sm:p-6 rounded-xl border-2 cursor-pointer transition-all ${deliveryMethod === "pickup"
                ? "border-[#C6A05C] bg-[#C6A05C]/5 shadow-md"
                : "border-gray-200 hover:border-gray-300 bg-white"}`}>
                        <input type="radio" value="pickup" checked={deliveryMethod === "pickup"} onChange={(e) => handleInputChange("deliveryMethod", e.target.value)} className="w-4 h-4 sm:w-5 sm:h-5 text-[#C6A05C] focus:ring-[#C6A05C] mt-0.5"/>
                      ...
                      <label className={`flex items-start gap-3 sm:gap-4 p-4 sm:p-6 rounded-xl border-2 cursor-pointer transition-all ${deliveryMethod === "delivery"
                ? "border-[#C6A05C] bg-[#C6A05C]/5 shadow-md"
                : "border-gray-200 hover:border-gray-300 bg-white"}`}>
                        <input type="radio" value="delivery" checked={deliveryMethod === "delivery"} onChange={(e) => handleInputChange("deliveryMethod", e.target.value)} className="w-4 h-4 sm:w-5 sm:h-5 text-[#C6A05C] focus:ring-[#C6A05C] mt-0.5"/>
                    ...
                    {deliveryMethod === "delivery" && (<motion.div initial={{ opacity: 0, height: 0 }} animate={{ opacity: 1, height: "auto" }} exit={{ opacity: 0, height: 0 }} transition={{ duration: 0.4 }} className="space-y-4 sm:space-y-6">
                    ...
                    <div>
                      ...
                      <Input id="name" value={formData.name} onChange={(e) => handleInputChange("name", e.target.value)} placeholder="山田 太郎" className="h-11 sm:h-12 bg-white border-gray-200 focus:border-[#C6A05C] transition-all" required/>
                    </div>
                    ...
                    <div>
                      ...
                      <Input id="email" type="email" value={formData.email} onChange={(e) => handleInputChange("email", e.target.value)} placeholder="example@email.com" className="h-11 sm:h-12 bg-white border-gray-200 focus:border-[#C6A05C] transition-all" required/>
                    </div>
                    ...
                    <div>
                      ...
                      <Input id="phone" value={formData.phone || ""} onChange={(e) => handleInputChange("phone", e.target.value)} placeholder="090-1234-5678" className="h-11 sm:h-12 bg-white border-gray-200 focus:border-[#C6A05C] transition-all"/>
                    </div>
                    ...
                    <div>
                      ...
                      <Input id="postalCode" value={formData.postalCode} onChange={(e) => handleInputChange("postalCode", e.target.value)} placeholder="123-4567" className="h-11 sm:h-12 bg-white border-gray-200 focus:border-[#C6A05C] transition-all" required/>
                    </div>
                    ...
                    <div>
                      ...
                      <Input id="prefecture" value={formData.prefecture} onChange={(e) => handleInputChange("prefecture", e.target.value)} placeholder="東京都" className="h-11 sm:h-12 bg-white border-gray-200 focus:border-[#C6A05C] transition-all" required/>
                    </div>
                    ...
                    <div>
                      ...
                      <Input id="city" value={formData.city} onChange={(e) => handleInputChange("city", e.target.value)} placeholder="渋谷区" className="h-11 sm:h-12 bg-white border-gray-200 focus:border-[#C6A05C] transition-all" required/>
                    </div>
                    ...
                    <div>
                      ...
                      <Input id="address" value={formData.address} onChange={(e) => handleInputChange("address", e.target.value)} placeholder="1-2-3" className="h-11 sm:h-12 bg-white border-gray-200 focus:border-[#C6A05C] transition-all" required/>
                    </div>
                    ...
                    <div>
                      ...
                      <Input id="building" value={formData.building || ""} onChange={(e) => handleInputChange("building", e.target.value)} placeholder="〇〇ビル 4F" className="h-11 sm:h-12 bg-white border-gray-200 focus:border-[#C6A05C] transition-all"/>
                    </div>
                    ...
                    <div>
                      ...
                      <Textarea id="notes" value={formData.notes || ""} onChange={(e) => handleInputChange("notes", e.target.value)} placeholder="プレゼント包装希望、配送時間帯のご希望など" className="min-h-[80px] sm:min-h-[100px] bg-white border-gray-200 focus:border-[#C6A05C] transition-all resize-none text-xs sm:text-sm"/>
                    </div>
                      </motion.div>)}

                    <div className="pt-2 sm:pt-4">
                      <Button type="submit" size="lg" className="w-full bg-[#222] hover:bg-[#333] text-white h-12 sm:h-14 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-0.5 group">
                ...
                <div className="lg:col-span-1">
                  <div className="lg:sticky lg:top-20 sm:top-24">
                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2, duration: 0.6 }} className="bg-white rounded-lg shadow-lg overflow-hidden border border-gray-100">
                      <div className="aspect-[4/3] relative overflow-hidden bg-gray-50">
                        <ImageWithFallback src={mockArtwork.image} alt={mockArtwork.title} className="w-full h-full object-cover"/>
                      </div>
          ...
          {currentStep === 2 && (<motion.div key="step2" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} transition={{ duration: 0.5 }} className="container mx-auto px-4 sm:px-6 max-w-3xl">
              <div className="space-y-6 sm:space-y-8">
                ...
                <form onSubmit={onSubmitStep2} className="space-y-4 sm:space-y-6">
                    <div className="space-y-2 sm:space-y-3">
                      <label className={`flex items-center gap-3 sm:gap-4 p-4 sm:p-5 rounded-lg border-2 cursor-pointer transition-all ${paymentMethod === "card"
                ? "border-[#C6A05C] bg-[#C6A05C]/5"
                : "border-gray-200 hover:border-gray-300"}`}>
                        <input type="radio" value="card" checked={paymentMethod === "card"} onChange={(e) => handleInputChange("paymentMethod", e.target.value)} className="w-4 h-4 sm:w-5 sm:h-5 text-[#C6A05C] focus:ring-[#C6A05C]"/>
                      ...
                      <label className={`flex items-center gap-3 sm:gap-4 p-4 sm:p-5 rounded-lg border-2 cursor-pointer transition-all ${paymentMethod === "apple-pay"
                ? "border-[#C6A05C] bg-[#C6A05C]/5"
                : "border-gray-200 hover:border-gray-300"}`}>
                        <input type="radio" value="apple-pay" checked={paymentMethod === "apple-pay"} onChange={(e) => handleInputChange("paymentMethod", e.target.value)} className="w-4 h-4 sm:w-5 sm:h-5 text-[#C6A05C] focus:ring-[#C6A05C]"/>
                    ...
                    {paymentMethod === "card" && (<motion.div initial={{ opacity: 0, height: 0 }} animate={{ opacity: 1, height: "auto" }} exit={{ opacity: 0, height: 0 }} transition={{ duration: 0.3 }} className="space-y-4 sm:space-y-6 pt-2 sm:pt-4">
                        <Separator className="bg-gray-200/50"/>
                        ...
                        <div>
                          ...
                          <Input id="cardNumber" value={formData.cardNumber || ""} onChange={(e) => handleInputChange("cardNumber", e.target.value)} placeholder="1234 5678 9012 3456" className="h-11 sm:h-12 bg-white border-gray-200 focus:border-[#C6A05C] transition-all"/>
                        </div>
                        ...
                        <div>
                          ...
                          <Input id="cardName" value={formData.cardName || ""} onChange={(e) => handleInputChange("cardName", e.target.value)} placeholder="TARO YAMADA" className="h-11 sm:h-12 bg-white border-gray-200 focus:border-[#C6A05C] transition-all"/>
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-3 sm:gap-4">
                          <div>
                            ...
                            <Input id="expiryDate" value={formData.expiryDate || ""} onChange={(e) => handleInputChange("expiryDate", e.target.value)} placeholder="MM/YY" className="h-11 sm:h-12 bg-white border-gray-200 focus:border-[#C6A05C] transition-all"/>
                          </div>
                          ...
                          <div>
                            ...
                            <Input id="cvv" value={formData.cvv || ""} onChange={(e) => handleInputChange("cvv", e.target.value)} placeholder="123" maxLength={4} className="h-11 sm:h-12 bg-white border-gray-200 focus:border-[#C6A05C] transition-all"/>
                          </div>
                        </div>
                    ...
                    <div className="pt-2 sm:pt-4 flex flex-col sm:flex-row gap-3 sm:gap-4">
                      <Button type="button" onClick={() => setCurrentStep(1)} variant="outline" size="lg" className="flex-1 h-12 sm:h-14 rounded-lg border-gray-300 hover:bg-gray-50">
                        <span className="text-sm sm:text-base">戻る</span>
                      </Button>
                      <Button type="submit" size="lg" className="flex-1 bg-[#222] hover:bg-[#333] text-white h-12 sm:h-14 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-0.5 group">
                        <span className="text-sm sm:text-base">次へ</span>
                        <ArrowRight className="w-4 h-4 sm:w-5 sm:h-5 ml-2 transition-transform group-hover:translate-x-1"/>
                      </Button>
                    </div>
          ...
          {currentStep === 3 && (<motion.div key="step3" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} transition={{ duration: 0.5 }} className="container mx-auto px-4 sm:px-6 max-w-4xl">
              <div className="space-y-8 sm:space-y-12">
                ...
                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2, duration: 0.6 }} className="bg-gradient-to-b from-gray-50 to-white p-6 sm:p-8 rounded-2xl border border-gray-100">
                ...
                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3, duration: 0.6 }} className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                  ...
                  <div className="bg-white p-4 sm:p-6 rounded-lg border border-gray-200">
                    ...
                    <div className="space-y-1.5 sm:space-y-2 text-xs sm:text-sm text-[#222]">
                      {formData.paymentMethod === "card" && (<>
                          ...
                          {formData.cardNumber && (<p className="text-gray-600">
                              **** **** **** {formData.cardNumber.slice(-4)}
                            </p>)}
                        </>)}
                      {formData.paymentMethod === "apple-pay" && (<p>Apple Pay</p>)}
                    </div>
                  </div>
                </motion.div>
                ...
                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.5, duration: 0.6 }} className="flex flex-col sm:flex-row gap-3 sm:gap-4 max-w-2xl mx-auto">
                  <Button type="button" onClick={() => setCurrentStep(2)} variant="outline" size="lg" className="flex-1 h-12 sm:h-16 rounded-lg border-gray-300 hover:bg-gray-50">
                    <span className="text-sm sm:text-base">戻る</span>
                  </Button>
                  <Button onClick={onSubmitStep3} size="lg" className="flex-1 bg-[#C6A05C] hover:bg-[#B89050] text-white h-12 sm:h-16 rounded-lg shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-1 hover:scale-105">
          ...
          {currentStep === 4 && (<motion.div key="step4" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 1 }} className="min-h-[calc(100vh-80px)] flex items-center justify-center">
              <div className="container mx-auto px-4 sm:px-6 max-w-3xl">
                ...
                delay: 0.2
                    ...
                    <div className="relative">
                      ...
                      <motion.div initial={{ opacity: 0, scale: 0 }} animate={{ opacity: 1, scale: 1 }} transition={{ delay: 0.6, duration: 0.8 }} className="absolute -top-1 -right-1 sm:-top-2 sm:-right-2">
                        <Sparkles className="w-6 h-6 sm:w-8 sm:h-8 text-[#C6A05C]"/>
                      </motion.div>
                    </div>
                  </motion.div>

                  <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4, duration: 0.8 }} className="space-y-4 sm:space-y-6">
                  ...
                  <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.6, duration: 1 }} className="max-w-md mx-auto">
                  ...
                  <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.8, duration: 0.8 }} className="space-y-3 sm:space-y-4">
                    <div className="inline-block px-4 sm:px-6 py-2 sm:py-3 bg-[#C6A05C]/10 rounded-full">
                      {formData.deliveryMethod === "pickup" ? (<div className="flex items-center gap-2">
                          <Home className="w-3 h-3 sm:w-4 sm:h-4 text-[#C6A05C]"/>
                    ...
                    {formData.deliveryMethod === "pickup" && (<motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.9, duration: 0.8 }} className="max-w-2xl mx-auto">
                  ...
                  {formData.deliveryMethod === "pickup" && (<motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 1, duration: 0.8 }} className="max-w-2xl mx-auto">
                  ...
                  <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: formData.deliveryMethod === "pickup" ? 1.2 : 1, duration: 0.8 }} className="max-w-xl mx-auto">
                  ...
                  <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: formData.deliveryMethod === "pickup" ? 1.4 : 1.2, duration: 0.8 }} className="space-y-3 sm:space-y-4 pt-4 sm:pt-8">
                    <Button onClick={() => navigate("/")} size="lg" className="bg-[#222] hover:bg-[#333] text-white px-8 sm:px-12 h-12 sm:h-14 rounded-lg">
                      トップページへ
                    </Button>
                    <div>
                      <button onClick={handleViewOtherWorks} className="text-xs sm:text-sm text-gray-500 hover:text-[#C6A05C] underline underline-offset-4 transition-colors">
                        このアーティストの他の作品を見る
                      </button>
                    </div>
                  </motion.div>
