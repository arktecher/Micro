...
export function BenefitsSection() {
    ...
    return (<section id="benefits" className="py-32 bg-gray-50" ref={ref}>
      <div className="max-w-7xl mx-auto px-6">
        <motion.div initial={{ opacity: 0, y: 30 }} animate={isInView ? { opacity: 1, y: 0 } : {}} transition={{ duration: ANIMATION_DURATION }} className="text-center mb-20">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {BENEFITS.map((benefit, index) => {
            ...
            return (<motion.div key={index} initial={{ opacity: 0, y: 50 }} animate={isInView ? { opacity: 1, y: 0 } : {}} transition={{
