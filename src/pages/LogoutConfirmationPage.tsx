...
export function LogoutConfirmationPage() {
    return (<div className="min-h-screen bg-white">
      ...
      <div className="container mx-auto px-4 sm:px-6 pt-20 sm:pt-32 pb-12 sm:pb-20">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="max-w-md mx-auto text-center">
          ...
          <div className="mt-8 sm:mt-12 pt-6 sm:pt-8 border-t border-gray-200">
            ...
            <div className="flex flex-col gap-2 sm:gap-3">
              <Link to="/login/customer" className="text-xs sm:text-sm text-primary hover:underline transition-colors">
                購入者としてログイン
              </Link>
              <Link to="/login/artist" className="text-xs sm:text-sm text-primary hover:underline transition-colors">
                アーティストとしてログイン
              </Link>
              <Link to="/login/corporate" className="text-xs sm:text-sm text-primary hover:underline transition-colors">
                法人としてログイン
              </Link>
            </div>
          </div>
