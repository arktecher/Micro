...
export function QRCodeManager({ spaceId, spaceName, currentArtworkId, currentArtworkTitle, qrCodeUrl: initialQrCodeUrl }: QRCodeManagerProps) {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="space-y-4">
              <div className="bg-white p-6 rounded-lg border-2 border-gray-200 flex flex-col items-center">
                <div id={`qr-canvas-${spaceId}`}>
                  <QRCodeSVG value={fullUrl} size={200} level="H" includeMargin={true}/>
                </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                {currentArtworkTitle ? (<div className="flex items-center gap-2">
                    <Badge className="bg-green-100 text-green-700">
                      <CheckCircle className="w-3 h-3 mr-1"/>
                      展示中
                    </Badge>
                    <span className="text-sm">{currentArtworkTitle}</span>
                  </div>) : (<p className="text-sm text-gray-400">作品未設定</p>)}
              </div>
        ...
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
          ...
          <div className="space-y-6 py-4">
            ...
            <div className="space-y-2">
              ...
              <Input placeholder="https://microgalleryjapan.com/artwork/1?source=qr" value={editedUrl} onChange={(e) => setEditedUrl(e.target.value)}/>
          ...
          <DialogFooter>
            ...
            <Button onClick={handleSaveUrl} disabled={!editedUrl.trim()}>
              保存
            </Button>
          </DialogFooter>
        </DialogContent>
