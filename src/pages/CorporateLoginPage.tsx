          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            ...
            <form onSubmit={handleLogin} className="space-y-5 sm:space-y-6">
              <div className="space-y-2">
                ...
                <Input id="email" type="email" placeholder="example@company.com" value={email} onChange={(e) => setEmail(e.target.value)} className="h-11 bg-gray-100 border-gray-200 focus:bg-white focus:border-primary" required/>
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <Link to="/forgot-password" className="text-sm text-[#A67C52] hover:underline transition-colors">
                  パスワードを忘れた
                </Link>
              </div>
            ...
            <div className="mt-6 sm:mt-8 text-center">
              <p className="text-sm text-gray-600">
                アカウントをお持ちでない方は
                <Link to="/signup/corporate" className="text-[#A67C52] hover:underline ml-1 transition-colors">
                  新規登録
                </Link>
              </p>
            </div>
