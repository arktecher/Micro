...
export function advanceGoOnlineQueue(currentArtworkId: string, navigate: (to: string) => void, options: {
    publishedThisStep: boolean;
}): void {
    ...
    const anyPublished = sessionStorage.getItem(GO_ONLINE_ANY_PUBLISHED_KEY) === "true";
