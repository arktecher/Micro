      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-4 sm:space-y-6 py-4 sm:py-6">
          ...
          <div>
            ...
            <Textarea value={reason} onChange={(e) => setReason(e.target.value)} placeholder="返却理由を入力してください&#10;&#10;例：&#10;・新しい作品を展示したいため&#10;・作品の修正が必要なため&#10;・展示期間が十分だったため" className="min-h-[120px] sm:min-h-[150px] resize-none text-sm sm:text-base" required/>
        ...
        <DialogFooter>
          ...
          <Button onClick={handleSubmit} disabled={!reason.trim() || isSubmitting} className="bg-[#C3A36D] hover:bg-[#C3A36D]/90 min-w-[160px] text-sm sm:text-base">
