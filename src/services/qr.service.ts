...
export async function generateSpaceQRCode(spaceId: string): Promise<SpaceQRCodeResponse> {
    return api.post<SpaceQRCodeResponse>(`/spaces/${spaceId}/qr-code`, {});
}
export async function getSpaceQRCode(spaceId: string): Promise<SpaceQRCodeResponse> {
