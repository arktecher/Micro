...
interface AuthContextType {
    ...
    login: (type: "artist" | "corporate" | "customer", userData?: {
        id: string;
        name: string;
        email: string;
    }) => void;
...
export function AuthProvider({ children }: {
    ...
    const corporateRole: CorporateOrgRole | null = currentUser?.type === "corporate" ? currentUser.corporateRole ?? null : null;
    ...
    const login = (type: "artist" | "corporate" | "customer", userData?: {
        id: string;
        name: string;
        email: string;
    }) => {
