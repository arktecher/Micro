...
import { Building2, TrendingUp, Sparkles, Upload, QrCode, Banknote, CheckCircle2, ArrowRight, ChevronRight, HelpCircle, ChevronDown, Mail, } from "lucide-react";
...
export function CorporatePage() {
        ...
        },
        {
            ...
            items: [
                ...
                },
                {
                    ...
                    answer: "— スペースの色・明るさ・トーン\n— 作品側の色味・スタイル\n— サイズ感\nなどを総合的に判定して候補を出します。",
                },
                {
                    question: "提案がイメージと違う場合は？",
                    answer: "「落ち着いた色が良い」「派手めは避けたい」などフィードバックいただければ、システム改善に反映します。",
                },
                {
            ...
            items: [
                {
                    ...
                    answer: "— 6か月以上の展示 → 作品返却時の送料はアーティスト負担\n— 6か月未満の展示 → 法人様負担\nというルールがあります。",
                },
                {
                    question: "送料負担のルールは？",
                    answer: "— 6か月以上展示 → アーティスト側が送料負担\n— 6か月未満で返却・交換 → 法人様負担\nこれがマイクロギャラリーの基本ルールです。",
                },
                {
                    question: "作品の入れ替えはどう調整しますか？",
                    answer: "展示終了前にマイクロギャラリーから連絡し、\n— 継続展示\n— 別作品に入れ替え\n— 展示終了\nを選択いただきます。",
                },
            ],
        },
        {
            ...
            items: [
                {
                    ...
                    answer: "マイクロギャラリーは輸送・展示期間の事故に対応する保険スキームを整備しています。\n通常利用の範囲での破損であれば、\n法人様に重大な過失がない限り、保険でカバーされる前提です。",
                },
                {
                    question: "紛失・盗難の場合は？",
                    answer: "状況をヒアリングし、警察届出・保険会社との調整の上、\n故意や重過失がなければ保険でカバーする方針です。",
                },
            ],
        },
        {
            ...
            items: [
                {
                    ...
                    answer: "乾いた柔らかい布で軽くホコリを払う程度で充分です。\n以下は避けてください：\n— 水・洗剤使用\n— 直射日光\n— 高湿度（浴室近くなど）",
                },
                {
    ...
    return (<div className="min-h-screen bg-white">
      ...
      <section id="corporate-hero" className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16 sm:pt-20">
        <div className="absolute inset-0 z-0">
          <ImageWithFallback src="https://images.unsplash.com/photo-1758448721149-aa0ce8e1b2c9?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtb2Rlcm4lMjBvZmZpY2UlMjBsb2JieSUyMGFydHxlbnwxfHx8fDE3NjExNzkzMzN8MA&ixlib=rb-4.1.0&q=80&w=1080" alt="Modern office lobby" className="w-full h-full object-cover"/>
          ...
          <div className="grid md:grid-cols-2 gap-8 sm:gap-12 md:gap-16 items-center max-w-6xl mx-auto">
            ...
            <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.8 }}>
              <div className="aspect-[4/3] rounded-xl sm:rounded-2xl overflow-hidden shadow-2xl">
                <ImageWithFallback src="https://images.unsplash.com/photo-1550605406-3d836450a56b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxlbXB0eSUyMHdoaXRlJTIwd2FsbCUyMG9mZmljZXxlbnwxfHx8fHwxNzYxMTc5ODM4fDA&ixlib=rb-4.1.0&q=80&w=1080" alt="Empty wall" className="w-full h-full object-cover"/>
              </div>
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-12 sm:py-16 md:py-24 bg-white">
        <div className="container mx-auto px-4 sm:px-6">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.8 }} className="text-center mb-8 sm:mb-12 md:mb-16">
          ...
          <div className="max-w-6xl mx-auto">
              ...
              {[
            {
                ...
                number: "01",
                title: "マイクロギャラリーに登録",
                description: "法人情報と展示スペースを入力。完全無料で始められます。",
            ...
            },
            {
                ...
                number: "02",
                title: "AI作品提案",
                description: "AIが空間に合うアートを提案。好きな作品を選択できます。",
            ...
            },
            {
                ...
                number: "03",
                title: "作品を展示",
                description: "QRコード・フック・展示マニュアルが届くので、それに沿って展示。",
            ...
            },
            {
                ...
                number: "04",
                title: "販売報酬10％",
                description: "来場者がQRから購入すると販売額の10％が収益に。",
                color: "from-primary to-primary/80",
            },
        ].map((item, index) => (<motion.div key={index} initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: index * 0.1 }}>
                  <Card className="border-2 hover:shadow-xl transition-all duration-300 h-full">
                    <CardHeader className="text-center pb-3 px-4 sm:px-6 pt-4 sm:pt-6">
                      <div className={`w-12 h-12 sm:w-16 sm:h-16 mx-auto rounded-xl sm:rounded-2xl bg-gradient-to-br ${item.color} flex items-center justify-center mb-3 shadow-lg`}>
        ...
        <div className="container mx-auto px-4 sm:px-6">
          ...
          <div className="max-w-5xl mx-auto grid sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8">
            {[
            {
                icon: CheckCircle2,
                title: "完全無料",
                description: "導入費・月額費ゼロ（初年度）。リスクなしで始められます。",
            ...
            },
            {
                icon: Sparkles,
                title: "ブランド価値向上",
                description: "空間にアートがあることで、企業イメージがアップします。",
                color: "from-primary to-primary/80",
            },
        ].map((item, index) => (<motion.div key={index} initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: index * 0.15 }}>
                <Card className="border-2 hover:shadow-xl transition-all duration-300 h-full">
                  <CardHeader className="text-center px-4 sm:px-6 pt-4 sm:pt-6">
                    <div className={`w-12 h-12 sm:w-16 sm:h-16 mx-auto rounded-lg sm:rounded-xl bg-gradient-to-br ${item.color} flex items-center justify-center mb-3 sm:mb-4 shadow-lg`}>
                      <item.icon className="w-6 h-6 sm:w-8 sm:h-8 text-white"/>
                    </div>
          ...
          <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} transition={{ duration: 0.8, delay: 0.5 }} className="mt-6 sm:mt-8 text-center">
        ...
        <div className="container mx-auto px-4 sm:px-6">
          ...
          <div className="max-w-4xl mx-auto space-y-4 sm:space-y-6">
            {[
            {
                step: "1",
                title: "登録する",
                description: "法人情報と展示スペースの情報（場所、壁のサイズ、写真など）を入力します。",
            },
            {
                step: "2",
                title: "AIによる作品提案を受け取る",
                description: "貴社の空間に合ったアート作品をAIが自動で選定し、提案します。",
            },
            {
                step: "3",
                title: "郵送された作品を展示する",
                description: "気に入った作品を選択すると、アーティストから直接郵送されます。QRコード付きで展示。",
            },
            {
                step: "4",
                title: "作品が売れたら、顧客がマイクロギャラリー上で決済",
                description: "来場者がQRコードをスキャンし、オンラインで購入。決済は全てマイクロギャラリーが代行します。",
            },
            {
                step: "5",
                title: "コミッションが3か月ごとに自動振込",
                description: "販売額の10％が貴社の報酬として、四半期ごとに自動で振り込まれます。",
            },
        ].map((item, index) => (<motion.div key={index} initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: index * 0.1 }}>
          ...
          <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} transition={{ duration: 0.8, delay: 0.6 }} className="mt-8 sm:mt-12 text-center text-sm sm:text-base text-gray-600 leading-relaxed max-w-3xl mx-auto">
            <p>
      ...
      <section className="py-12 sm:py-16 md:py-24 bg-gradient-to-b from-gray-50 to-white">
        <div className="container mx-auto px-4 sm:px-6">
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.8 }} className="max-w-5xl mx-auto">
            ...
            "作品選定は限られた選択肢から",
            "収益化の仕組みがない",
        ].map((text, i) => (<div key={i} className="flex items-start gap-2 sm:gap-3">
        ...
        <div className="container mx-auto px-4 sm:px-6">
          ...
          <div className="max-w-4xl mx-auto space-y-8 sm:space-y-12">
            {faqData.map((category, categoryIndex) => (<div key={categoryIndex}>
                <motion.h3 initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }} className="text-xl sm:text-2xl text-primary mb-4 sm:mb-6 pb-2 sm:pb-3 border-b-2 border-primary/20">
                  {category.category}
                </motion.h3>
                          ...
                          <CardContent className="p-4 sm:p-6">
                            <div className="flex items-start justify-between gap-3 sm:gap-4">
                              <div className="flex-grow min-w-0">
                                ...
                                {isOpen && (<motion.div initial={{ opacity: 0, height: 0 }} animate={{ opacity: 1, height: "auto" }} exit={{ opacity: 0, height: 0 }} className="text-sm sm:text-base text-gray-700 leading-relaxed mt-2 sm:mt-3 pt-2 sm:pt-3 border-t border-gray-200 whitespace-pre-line">
                                    A. {faq.answer}
                                  </motion.div>)}
                              </div>
                              <ChevronDown className={`w-5 h-5 sm:w-6 sm:h-6 text-primary flex-shrink-0 transition-transform duration-300 ${isOpen ? "rotate-180" : ""}`}/>
                            </div>
                          </CardContent>
                        </Card>
                      </motion.div>);
              ...
              <CardContent className="p-6 sm:p-8 md:p-10">
                <div className="space-y-6 sm:space-y-8">
                  <div className="text-center">
                    ...
                    <div className="flex flex-col items-center gap-3 sm:gap-4">
                      <div className="flex items-center gap-2 sm:gap-3 text-lg sm:text-xl text-primary">
                        ...
                        <a href="mailto:support@microgallery.co.jp" className="hover:underline break-all sm:break-normal">
                  ...
                  <div className="pt-6 sm:pt-8 border-t border-gray-200">
                    ...
                    <div className="text-center">
                      <Button size="lg" onClick={() => navigate("/contact")} className="bg-primary hover:bg-primary/90 text-white h-12 sm:h-14 px-6 sm:px-10 text-base sm:text-lg w-full sm:w-auto">
                        お問い合わせフォームを開く
      ...
      <section id="register-cta" className="relative py-16 sm:py-24 md:py-32 overflow-hidden">
        <div className="absolute inset-0 z-0">
          <ImageWithFallback src="https://images.unsplash.com/photo-1596386461350-326ccb383e9f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxob3RlbCUyMHJlY2VwdGlvbiUyMGFydHdvcmt8ZW58MXx8fHwxNzYxMTc5MzM0fDA&ixlib=rb-4.1.0&q=80&w=1080" alt="Hotel reception" className="w-full h-full object-cover"/>
